  ...
  class EditorState {
    ...
    */
    static transactionFilter: Facet<
      ...
      readonly ((tr: Transaction) => TransactionSpec | readonly TransactionSpec[])[]
    >;
    /**
    ...
    */
    static transactionExtender: Facet<
      ...
      readonly ((tr: Transaction) => Pick<TransactionSpec, 'effects' | 'annotations'> | null)[]
    >;
  }
